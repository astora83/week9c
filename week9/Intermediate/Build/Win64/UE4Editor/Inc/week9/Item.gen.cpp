...
// Cross Module References
	WEEK9_API UClass* Z_Construct_UClass_AItem_NoRegister();
	WEEK9_API UClass* Z_Construct_UClass_AItem();
...
// End Cross Module References
	DEFINE_FUNCTION(AItem::execOnOverLapBegin)
	{
		...
		P_GET_STRUCT_REF(FHitResult,Z_Param_Out_SweepResulte);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->OnOverLapBegin(Z_Param_OverLappedComponent,Z_Param_OtherActor,Z_Param_OtherComp,Z_Param_OtherBodyIndex,Z_Param_bfromSweep,Z_Param_Out_SweepResulte);
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_AItem_OnOverLapBegin_Statics
	{
		struct Item_eventOnOverLapBegin_Parms
		{
			...
			bool bfromSweep;
			FHitResult SweepResulte;
		};
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SweepResulte_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_SweepResulte;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::NewProp_SweepResulte_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::NewProp_SweepResulte = { "SweepResulte", nullptr, (EPropertyFlags)0x0010008008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Item_eventOnOverLapBegin_Parms, SweepResulte), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::NewProp_SweepResulte_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::NewProp_SweepResulte_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AItem_OnOverLapBegin_Statics::NewProp_SweepResulte,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AItem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AItem_OnOverLapBegin, "OnOverLapBegin" }, // 3859173990
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AItem, 722318076);
	template<> WEEK9_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItem(Z_Construct_UClass_AItem, &AItem::StaticClass, TEXT("/Script/week9"), TEXT("AItem"), false, nullptr, nullptr, nullptr);
